...
// C Modes
    ...
    'C Dorian': [
        ...
        { string: '3', fret: '7' }, { string: '3', fret: '8' }, { string: '3', fret: '10' },
        { string: '2', fret: '8' }, { string: '2', fret: '10' }, { string: '2', fret: '11' },
        { string: '1', fret: '8' }, { string: '1', fret: '10' }
    ],
    'C Phrygian': [
        { string: '6', fret: '8' }, { string: '6', fret: '9' }, { string: '6', fret: '11' },
        { string: '5', fret: '8' }, { string: '5', fret: '10' }, { string: '5', fret: '11' },
        { string: '4', fret: '8' }, { string: '4', fret: '10' },
        { string: '3', fret: '7' }, { string: '3', fret: '8' }, { string: '3', fret: '10' },
        { string: '2', fret: '8' }, { string: '2', fret: '9' }, { string: '2', fret: '11' },
    ...
    'C Mixolydian': [
        { string: '6', fret: '8' }, { string: '6', fret: '10' }, 
        { string: '5', fret: '7' }, { string: '5', fret: '8' }, { string: '5', fret: '10' },
        { string: '4', fret: '7' }, { string: '4', fret: '8' }, { string: '4', fret: '10' },
        { string: '3', fret: '7' }, { string: '3', fret: '9' }, { string: '3', fret: '10' },
        { string: '2', fret: '8' }, { string: '2', fret: '10' }, { string: '2', fret: '11' },
        { string: '1', fret: '8' }
    ],
...
// D Modes
    ...
    'D Phrygian': [
        { string: '6', fret: '10' }, { string: '6', fret: '11' }, { string: '6', fret: '13' },
        { string: '5', fret: '10' }, { string: '5', fret: '12' }, { string: '5', fret: '13' },
        { string: '4', fret: '10' }, { string: '4', fret: '12' }, { string: '4', fret: '13' },
        { string: '3', fret: '10' }, { string: '3', fret: '12' },
        { string: '2', fret: '10' }, { string: '2', fret: '11' }, { string: '2', fret: '13' },
        { string: '1', fret: '10' }, { string: '1', fret: '11' }, { string: '1', fret: '13' }
    ],
    'D Lydian': [
        { string: '6', fret: '10' }, { string: '6', fret: '12' }, 
        { string: '5', fret: '9' }, { string: '5', fret: '11' }, { string: '5', fret: '12' },
...
// A Modes
    ...
    'A Dorian': [
        ...
        { string: '4', fret: '4' }, { string: '4', fret: '7' },
        { string: '3', fret: '4' }, { string: '3', fret: '5' }, { string: '3', fret: '7' },
        { string: '2', fret: '5' }, { string: '2', fret: '7' }, { string: '2', fret: '8' },
        { string: '1', fret: '5' }, { string: '1', fret: '7' }
    ],
    'A Phrygian': [
        { string: '6', fret: '5' }, { string: '6', fret: '6' }, { string: '6', fret: '8' },
        { string: '5', fret: '5' }, { string: '5', fret: '7' }, { string: '5', fret: '8' },
        { string: '4', fret: '5' }, { string: '4', fret: '7' },
        { string: '3', fret: '4' }, { string: '3', fret: '5' }, { string: '3', fret: '7' },
        { string: '2', fret: '5' }, { string: '2', fret: '6' }, { string: '2', fret: '8' },
